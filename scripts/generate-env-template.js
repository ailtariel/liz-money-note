...
function resolveSourceEnvPath(rootDir) {
  const candidates = ['.env.example', '.env', '.env.production', '.env.development'];
...
function writeTemplate(rootDir) {
...
export default function generateEnvTemplate() {
  return {
